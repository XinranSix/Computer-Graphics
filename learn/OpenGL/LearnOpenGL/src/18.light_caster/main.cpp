...
int main() {
    ...
    Shader lightingShader("./shader/18.light_caster/1.colors.vert", "./shader/18.light_caster/1.colors.frag");
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        lightingShader.use();
        lightingShader.setFloat("light.position", camera.Position.x, camera.Position.y, camera.Position.z);
        lightingShader.setFloat("light.direction", camera.Front.x, camera.Front.y, camera.Front.z);
