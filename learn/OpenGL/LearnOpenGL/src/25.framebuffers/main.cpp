...
int main() {
    ...
    // -------------------------
    Shader shader("./shader/25.framebuffers/5.1.framebuffers.vs", "./shader/25.framebuffers/5.1.framebuffers.fs");
    Shader screenShader("./shader/25.framebuffers/5.1.framebuffers_screen.vs",
                        "./shader/25.framebuffers/5.1.framebuffers_screen.fs");
