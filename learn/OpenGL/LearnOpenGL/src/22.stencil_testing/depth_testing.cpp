...
int main() {
    ...
    // -------------------------
    Shader shader("./shader/22.stencil_testing/2.stencil_testing.vs",
                  "./shader/22.stencil_testing/2.stencil_testing.fs");
    Shader shaderSingleColor("./shader/22.stencil_testing/2.stencil_testing.vs",
                             "./shader/22.stencil_testing/2.stencil_single_color.fs");
