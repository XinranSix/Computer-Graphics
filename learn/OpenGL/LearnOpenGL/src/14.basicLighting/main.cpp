...
int main() {
    ...
    Shader lightingShader("./shader/14.basicLighting/1.colors.vert", "./shader/14.basicLighting/1.colors.frag");
    Shader lightCubeShader("./shader/14.basicLighting/1.light_cube.vert",
                           "./shader/14.basicLighting/1.light_cube.frag");
