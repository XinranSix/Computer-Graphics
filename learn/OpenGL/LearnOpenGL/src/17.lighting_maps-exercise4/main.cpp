...
int main() {
    ...
    Shader lightingShader("./shader/17.lighting_maps-exercise4/1.colors.vert",
                          "./shader/17.lighting_maps-exercise4/1.colors.frag");
    Shader lightCubeShader("./shader/17.lighting_maps-exercise4/1.light_cube.vert",
                           "./shader/17.lighting_maps-exercise4/1.light_cube.frag");
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        lightingShader.setFloat("matrixlight", (1.0 + sin(currentFrame)) / 2 + 0.5);
