...
int main() {
    ...
    Shader lightingShader("./shader/17.lighting_maps/1.colors.vert", "./shader/17.lighting_maps/1.colors.frag");
    Shader lightCubeShader("./shader/17.lighting_maps/1.light_cube.vert",
                           "./shader/17.lighting_maps/1.light_cube.frag");
