...
int main() {
    ...
    // -------------------------
    Shader shader("./shader/25.framebuffers_exercise1/5.2.framebuffers.vs",
                  "./shader/25.framebuffers_exercise1/5.2.framebuffers.fs");
    Shader screenShader("./shader/25.framebuffers_exercise1/5.2.framebuffers_screen.vs",
                        "./shader/25.framebuffers_exercise1/5.2.framebuffers_screen.fs");
