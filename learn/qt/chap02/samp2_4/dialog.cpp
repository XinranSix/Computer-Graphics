...
{
    ui->setupUi(this);
    connect(ui->radioBlack, SIGNAL(clicked(bool)), this, SLOT(do_setFontColor()));
    connect(ui->radioRed, SIGNAL(clicked(bool)), this, SLOT(do_setFontColor()));
    connect(ui->radioBlue, SIGNAL(clicked(bool)), this, SLOT(do_setFontColor()));
}
